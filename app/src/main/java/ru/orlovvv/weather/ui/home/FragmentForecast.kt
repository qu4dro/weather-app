...
import ru.orlovvv.weather.databinding.FragmentForecastBinding
import ru.orlovvv.weather.viewmodels.ForecastViewModel

@AndroidEntryPoint
class FragmentForecast : Fragment(R.layout.fragment_forecast) {
    ...
    private fun setupUI() {
        binding.apply {
            ...
            lifecycleOwner = this@FragmentForecast
